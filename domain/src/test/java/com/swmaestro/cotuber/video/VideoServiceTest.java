...
class VideoServiceTest {
    @DisplayName("에러 상태에서 비디오 다운로드를 요청할 경우 비디오의 상태는 다운로드 중이 된다")
    @Test
    void startVideoDownloadTest() {
        // given
        ...
        Video video = Video.builder()
                .id(0)
                .youtubeUrl("https://www.youtube.com/watch?v=1234")
                .s3Url(null)
                .title(null)
                .videoTotalSecond(0)
        ...
        // when
        videoService.startVideoDownload(video);

        // then
        assertThat(video.getVideoStatus()).isEqualTo(VideoStatus.VIDEO_DOWNLOADING);
    }
