...
import com.swmaestro.cotuber.domain.user.OAuthUserInfo;
import com.swmaestro.cotuber.domain.user.User;
import com.swmaestro.cotuber.domain.user.UserEditor;
import com.swmaestro.cotuber.domain.user.UserReader;
